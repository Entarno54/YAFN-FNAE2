...
function UIHandler.ToggleUISongPickVisibility(state:boolean)
	local funnyTweens
	if state then
		-- set their positions
...
local settingButton = require(RepS.Modules.Topbar).new()
	:setImage(7059346373)
...
scrollCategory.ScrollBarThickness = 3
...
local open = false
print(settingButton)
settingButton.toggled:Connect(function()
	if open then
		open = false
...
local offColor,onColor =  Color3.new(0.168627, 0, 1),Color3.new(0.494118, 0.537255, 0.831373)
