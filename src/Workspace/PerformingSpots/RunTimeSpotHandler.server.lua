			...
			local thread_Round = function()
				...
				compRemote.OnServerEvent:Connect(function(plr,msg,...) -- COMPERTITION REMOTE
					...
					if BFSongOver and DadSongOver then -- Song Over
						...
						print(POI)
						print(songModule.Parent.Name)
						if POI.BFSpot.Owner and POI.DadSpot.Owner then
							if SpotRoundStats.BFScore > SpotRoundStats.DadScore then
								game.ReplicatedStorage.Messager:FireAllClients(POI.BFSpot.Owner.Name .. " won against ".. POI.DadSpot.Owner.Name.. " on song "..songModule.Parent.Name.." having ".. SpotRoundStats.BFScore - SpotRoundStats.DadScore.. " higher score!")
							else 
								game.ReplicatedStorage.Messager:FireAllClients(POI.DadSpot.Owner.Name .. " won against ".. POI.BFSpot.Owner.Name.. " on song "..songModule.Parent.Name.." having ".. SpotRoundStats.DadScore - SpotRoundStats.BFScore.. " higher score!")
							end
						end
						if POI.DadSpot.Owner then
